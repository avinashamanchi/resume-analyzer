...
| Privacy and self-help pages | PASS for public content; in-app opening UNVERIFIED | All three public pages returned HTTPS 200 anonymously on 2026-08-14 and matched the tracked release files byte for byte. Confirm link opening on the actual iPhone. |
